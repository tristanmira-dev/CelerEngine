...
/*DISCLAIMER, PLS DONT SWAP ORDER OF THESE CUZ OF LIFETIME DEPENDANCY, PADDING BE DAMNED*/
...
namespace Celer {
	...
	namespace Core {
		...
		private:
			...
			uint32_t mTransferQueueIdx{ static_cast<uint32_t>(~0) };
